...
class MailAppScreen extends StatefulWidget {
  ...
  @override
  State<MailAppScreen> createState() => _MailAppScreenState();
}

class _MailAppScreenState extends State<MailAppScreen> {
  int index = 0;
  bool value = false;
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(height: 32, child: const VerticalDivider()),
                          IconButton.ghost(
                            onPressed: () {},
                                    ...
                                    builder: (context) {
                                      return const DropdownMenu(
                                        children: [
                                          ...
                                          MenuButton(child: Text("Add label")),
                                          MenuButton(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              const Text("William Smith").bold,
                              const Text("Meeting Tomorrow").small,
                              const Text("Reply-To: william@smith.com").small,
                            ],
                          ),
                          const Spacer(),
